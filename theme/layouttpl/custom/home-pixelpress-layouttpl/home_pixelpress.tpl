<div class="home-pixelpress" id="main-content" role="main">
	<div class="portlet-layout" id="first-row">
		<div class="portlet-column portlet-column-only" id="column-1">
			$processor.processColumn("column-1", "portlet-column-content portlet-column-content-only")
		</div>
	</div>
	<div class="portlet-layout clearfix" id="second-row">
	...
	<div class="portlet-layout" id="third-row">
